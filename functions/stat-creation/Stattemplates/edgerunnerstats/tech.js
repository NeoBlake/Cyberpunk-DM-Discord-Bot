...
async function tech(interaction) {
    ...
    Data.findOne({
        ...
        const INTnumbers = [6,7,8,7,6,8,8,8,6,8];
        const REFnumbers = [7,6,6,8,6,7,6,8,6,8];
        const DEXnumbers = [7,6,5,7,7,5,7,7,7,5];
        const TECHnumbers = [8,7,7,8,6,6,8,8,8,6];
        const COOLnumbers = [4,5,5,4,4,3,4,5,3,4];
        const WILLnumbers = [4,3,4,4,3,3,4,4,3,4];
        const LUCKnumbers = [5,7,7,6,7,7,7,6,5,6];
        const MOVEnumbers = [5,7,7,5,7,6,6,5,7,5];
        const BODYnumbers = [7,5,5,6,6,6,7,6,7,6];
        const EMPnumbers = [6,5,7,7,6,7,6,6,7,6];

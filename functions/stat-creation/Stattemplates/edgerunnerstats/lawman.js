...
async function lawman(interaction) {
    ...
    Data.findOne({
        ...
        const INTnumbers = [5,6,5,6,6,7,7,5,7,6];
        const REFnumbers = [6,6,7,6,6,6,8,6,7,6];
        const DEXnumbers = [7,6,7,7,7,5,7,6,5,5];
        const TECHnumbers = [5,5,7,6,6,5,5,5,5,6];
        const COOLnumbers = [7,6,6,6,7,7,6,6,7,8];
        const WILLnumbers = [8,8,7,8,7,8,8,8,7,7];
        const LUCKnumbers = [5,5,5,5,6,5,7,5,6,5];
        const MOVEnumbers = [6,7,5,7,5,6,6,7,5,7];
        const BODYnumbers = [5,5,7,7,5,7,5,6,5,6];
        const EMPnumbers = [6,5,6,6,6,4,4,4,6,6];
